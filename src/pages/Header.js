...
const Header = () => {
  return (
    <header className="w-full col-start-2 col-end-12 flex flex-col justify-center items-center gap-16">
      <div className="bg-primaryWhite/5 w-full flex items-center justify-center h-80 xtraSm:h-[400px] smTab:h-[480px]">
        <div className="w-56 h-56 rounded-full bg-secondaryRed smTab:h-80 smTab:w-80"></div>
      </div>
      {/**/}
      <div className="w-full text-center flex flex-col justify-center items-center gap-20">
        <h1 className="text-2xl font-extralight inline-flex flex-col justify-center items-center gap-4">
          Hi, I'm David Henery
          <span className="text-5xl tracking-wider leading-[58px] font-normal smTab:text-7xl">
            {" "}
            Frontend Developer
          </span>
