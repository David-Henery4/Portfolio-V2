...
const Skills = () => {
  return (
    <div className="w-full col-start-2 col-end-12 flex flex-col justify-center items-center py-12 gap-20 lrgDesk:col-start-4 lrgDesk:col-end-[14] lrgDesk:gap-32 relative">
