...
const About = () => {
  return (
    <main className="w-full col-start-2 col-end-12 flex flex-col justify-center items-center gap-14 pt-12 smDesk:flex-row-reverse lrgDesk:col-start-3 lrgDesk:col-end-13 xtraLrgDesk:col-start-4 xtraLrgDesk:col-end-[14]">
